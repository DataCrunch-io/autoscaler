...
func EncodeJSONValue(v datacrunch.JSONValue, escape EscapeMode) (string, error) {
...
//
// Will panic if the escape mode is unknown.
func DecodeJSONValue(v string, escape EscapeMode) (datacrunch.JSONValue, error) {
	var b []byte
	var err error
